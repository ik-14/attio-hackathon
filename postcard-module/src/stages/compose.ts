...
import type { BrandKit, ComposedCard, Copy } from "../types.js";
...
// Approximate Helvetica wrap: average glyph ≈ 0.54 × font-size.
...
async function buildBack(
  ...
  // Left column = message; right ~40% stays clear for Lob address + postage.
